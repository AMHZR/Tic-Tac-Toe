...
import os
import sys
sys.path.insert(1, os.path.join(os.path.dirname(__file__), 'game'))
DEBUG = True
...
SECRET_KEY = '+1(f_xgf*vy7(&(1kqg1+=e$-9iq!^)!_lo0$-med0w^=@%sjb'
...
TEMPLATE_DIRS = (
    ...
    os.path.join(os.path.dirname(__file__), 'static/theme/html'),
)
